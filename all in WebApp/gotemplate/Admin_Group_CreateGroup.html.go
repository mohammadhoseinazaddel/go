...
func AdminCreateGroupHandler(messages []string, w io.Writer) {
...
<div class="col-12 col-md-8">
    <div class="card">
        ...
        <div class="card-body">
            <form action="/Admin/AddGroup" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label class="control-label">عنوان فارسی</label>
                    <input name="title" class="form-control" />
                </div>
                <div class="form-group">
                    <label class="control-label">عنوان انگلیسی</label>
                    <input name="enTitle" class="form-control" />
                </div>
                <div class="form-group">
